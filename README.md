[survia_investor_v3.html](https://github.com/user-attachments/files/27098112/survia_investor_v3.html)
<!DOCTYPE html>
...
<section id="journey">
  ...
  <div class="r"><div class="sec-label">رحلة العميل</div><h2 class="sec-title">ثلاثة مسارات —<br>كل عميل يختار عمق المشاركة</h2><p class="sec-desc">من الاستخدام الذاتي للمنصة، إلى المسار المدعوم باستشاري بحثي، إلى الخدمة الكاملة بفريق بحث متعدد التخصصات. العميل يختار المسار المناسب حسب طبيعة دراسته وأهدافه.</p></div>

  <div class="tiers">
    <!-- TIER 1: SELF-SERVE -->
    <div class="tier r d1">
      <div class="tier-name">المسار الأول · ذاتي</div>
      <div class="tier-title">المنصة الذاتية</div>
      <div class="tier-for">للشركات الصغيرة والمتوسطة</div>
      <div class="tier-feat">
        ...
        <div class="tf">لوحة تحكم تفاعلية</div>
    ...
    <div class="tier featured r d2">
      ...
      <div class="tier-title">المنصة + استشاري بحثي</div>
      <div class="tier-for">للشركات النامية والعلامات التجارية</div>
      <div class="tier-feat">
        <div class="tf">كل مزايا المسار الأول</div>
        ...
        <div class="tf">تحليل إحصائي + تقرير تنفيذي</div>
    ...
    <div class="tier r d3">
      ...
      <div class="tier-title">فريق بحثي متكامل</div>
      <div class="tier-for">للمؤسسات الكبرى والجهات الحكومية</div>
      <div class="tier-feat">
        <div class="tf">كل مزايا المسار الثاني</div>
        ...
        <div class="tf">مدير حساب مخصص + متابعة مستمرة</div>
      </div>
    </div>
  </div>

  <!-- PRICING NOTE -->
  <div class="r d3" style="margin-top:18px;">
    <div style="background:rgba(255,255,255,0.03);border:1px dashed var(--gold-line);border-radius:12px;padding:16px 22px;display:flex;align-items:center;gap:14px;justify-content:center;flex-wrap:wrap;">
      <div style="width:38px;height:38px;border-radius:9px;background:var(--gold-dim);border:1px solid var(--gold-line);display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0;">💼</div>
      <div style="text-align:center;">
        <div style="font-size:13px;font-weight:700;color:var(--gold);margin-bottom:3px;">تسعير مخصص لكل عميل</div>
        <div style="font-size:12px;color:var(--dim);line-height:1.6;">في المرحلة الحالية نقدّم تسعيراً مرناً مبنياً على حجم العميل ونطاق الدراسة وعمق التحليل المطلوب — تواصل معنا لعرض مخصص.</div>
      </div>
    </div>
  </div>
  ...
  <div class="phases r d1">
    <div class="phase hl">
      ...
      <div class="ph-items">
        ...
        <div class="pi">تأسيس شبكة الخبراء البحثيين بالتعاقد</div>
        <div class="pi">تطوير قوالب الدراسات لقطاعات متعددة</div>
        <div class="pi">إطلاق نسخة تجريبية مع عملاء أوليين</div>
      </div>
      <div class="ph-kpi"><div class="k">الهدف</div><div class="v">إطلاق MVP + شبكة الخبراء ✓</div></div>
    </div>
    <div class="phase">
      ...
      <div class="ph-items">
        ...
        <div class="pi">إبرام عقود أولى مع مؤسسات مستهدفة</div>
        <div class="pi">بناء قاعدة دراسات حالة موثّقة</div>
      </div>
      <div class="ph-kpi"><div class="k">الهدف</div><div class="v">عقود مؤسسية أولى + اعتمادات</div></div>
    </div>
    <div class="phase">
      ...
      <div class="ph-items">
        ...
        <div class="pi">توسيع شبكة الخبراء لتغطي قطاعات جديدة</div>
        <div class="pi">توسّع إقليمي نحو الإمارات والكويت</div>
      </div>
      <div class="ph-kpi"><div class="k">الهدف</div><div class="v">قاعدة عملاء نشطة وانتشار إقليمي</div></div>
    </div>
  </div>
...
<section id="financial">
  ...
  <div class="fin-layout">
    <div class="r d1">
      ...
      <div class="rev-mix">
        <div class="rm"><div class="p">25٪</div><div class="n">اشتراكات</div><div class="d">المنصة الذاتية</div></div>
        <div class="rm"><div class="p">40٪</div><div class="n">مشاريع بحثية</div><div class="d">المسار المدعوم</div></div>
        <div class="rm"><div class="p">35٪</div><div class="n">عقود مؤسسية</div><div class="d">الخدمة الكاملة</div></div>
      </div>
    </div>
...
<section id="team">
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:16px;" class="r d5">
